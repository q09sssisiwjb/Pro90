const socialLinks = [
  ...
  {
    name: "Twitter",
    href: "https://twitter.com/visionaryai",
    icon: (
      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: "Instagram",
    href: "https://instagram.com/visionaryai",
    icon: (
      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: "Discord",
    href: "https://discord.gg/visionaryai",
    icon: (
      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
...
const Footer = () => {
  return (
    <footer className="bg-muted/20 border-t border-border/40 py-12" data-testid="footer">
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="flex items-center gap-3 mb-6 md:mb-0" data-testid="footer-logo">
          ...
          <div className="flex items-center space-x-6" data-testid="social-links">
        ...
        <div className="border-t border-border/40 mt-8 pt-8 text-center text-muted-foreground text-sm" data-testid="copyright">
          <p>&copy; 2024 Visionary AI. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
